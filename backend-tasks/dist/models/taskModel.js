...
class TaskModel {
    ...
    static createTask({ description, completed, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield Database_1.Database.connect();
                const [result] = yield Database_1.Database.executeQuery("INSERT INTO tareas (titulo, descripcion, completada) VALUES (?, ?)", [description, completed]);
